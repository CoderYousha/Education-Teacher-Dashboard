                    ...
                    wait ?
                         ...
                         <section className="bg-blue-color w-screen h-screen overflow-auto">
                              <div className="bg-white h-screen w-1/2 float-right max-sm:w-11/12" style={{ borderRadius: "70px 0 0 70px" }}>
                                   <h1 className="text-center font-bold text-2xl mt-32">Forgot Password</h1>
                                   <div id="page1" className="flex flex-col items-center h-1/2 mt-10">
                                   ...
                                   <div id="page2" className="flex-col items-center h-1/2 mt-10 hidden">
                                        <OTPInput
                                             numInputs={6}
                                             inputStyle={{
                                                  width: "3rem",
                                        ...
                                        />
                                        <br />
                                        <div className="flex flex-col items-center h-1/2 mt-10 w-full">
